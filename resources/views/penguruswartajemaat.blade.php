...
<body>
    <div class="wrapper">
      ...
      <div id="content">
          ...
          <a href="/isiwartajemaat"><button type="button" class="btn btn-primary">Add</button> </a>
          <hr>
          <br>
          ...
          <div class="table-responsive" col-lg-8>
            ...
            <table class="table table-striped table-sm">
                ...
                <tr>
                    ...
                    <td>
                      <li class="list-group-item"><a class="badge bg-danger"><i class="bi bi-file-earmark-pdf-fill"></i></a>   Warta Jemaat Maret 2022 Minggu ke 4.pdf</li>
                    </td>
                    ...
                    <td>
                      ...
                      <button class="badge bg-danger border-0" onclick="return confirm('Delete Warta Jemaat ?')"><i class="bi bi-backspace"></i></button>
                      </form>
