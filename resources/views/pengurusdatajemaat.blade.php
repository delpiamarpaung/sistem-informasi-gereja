  ...
  <body>
    ...
    <div class="wrapper">
      ...
      <div id="content">
          ...
          <a href="/isidatajemaat" class="btn btn-primary">Add</a>
          <hr>
          <br>
          ...
          <div class="table-responsive" col-lg-8>
            ...
            <table class="table table-striped table-sm">
                ...
                <tr>
                    ...
                    <td>
                    <li class="list-group-item">Marwani
                    </td>
                    <td>
                    <li class="list-group-item">28 Maret 2001
                    </td>
                    <td>
                    <li class="list-group-item">Indonesia
                    </td>
                    <td>
                        <a href="/ubahdatajemaat"class="badge bg-info"><i class="bi bi-pencil-square"></i></a>
                        </td>
                    <td>
