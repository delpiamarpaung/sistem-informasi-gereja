...
<body>
    <div class="wrapper">
      ...
      <div id="content">
              ...
              <div class="container-fluid">
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                      <ul class="nav navbar-nav ml-auto">
                          ...
                          <li class="nav-item active">
                            <a class="nav-link" href="/isirenunganharian">Isi</a>
                        </li>
                      </ul>
                  </div>
              </div>
          ...
          <div class="col-lg-8">
            <form method="post" action="/uploadrenunganharian">
              @csrf
                 <div class="mb-3">
                  <label for="subject" class="form-label">Tanggal Renungan</label>
                  <input type="date" class="form-control" id="tanggal_renungan" name="tanggal_renungan">
                </div>
                <div class="mb-3">
                  <label for="subject" class="form-label">Ayat Renungan</label>
                  <input type="text" class="form-control" id="ayat_renungan" name="ayat_renungan">
                </div>
        
                <div class="mb-3">
                    <label for="slug" class="form-label">Judul Renungan</label>
                    <input type="text" class="form-control  " id="judul_renungan" name="judul_renungan">
                  </div>
        
                  
                  <div class="container">
                    <label for="slug" class="form-label">Isi Renungan</label>
                    <textarea rows="10" cols="100" name="isi_renungan"></textarea>
                  </div>
